...
div_names = [
    ...
    "Path Length L2",
    "Path Length Linf",
    "Path Length L1 (reverse)",
    "Path Length L2 (reverse)",
    "Path Length Linf (reverse)",
    "Path Length Hist Wasserstein",
    "Path Length Hist L1",
    "Path Length Hist L2",
    "Path Length Hist Linf",
    "Cophenetic Length L1",
    "Cophenetic Length L2",
    "Cophenetic Length Linf",
    "Cophenetic Length L1 (reverse)",
    "Cophenetic Length L2 (reverse)",
    "Cophenetic Length Linf (reverse)",
    "Cophenetic Length Hist Wasserstein",
    "Cophenetic Length Hist L1",
    "Cophenetic Length Hist L2",
    "Cophenetic Length Hist Linf",
    "Path Weight L1",
    "Path Weight L2",
    "Path Weight Linf",
    "Path Weight L1 (reverse)",
    "Path Weight L2 (reverse)",
    "Path Weight Linf (reverse)",
    "Path Weight Hist Wasserstein",
    "Path Weight Hist L1",
    "Path Weight Hist L2",
    "Path Weight Hist Linf",
    "Cophenetic Weight L1",
    "Cophenetic Weight L2",
    "Cophenetic Weight Linf",
    "Cophenetic Weight L1 (reverse)",
    "Cophenetic Weight L2 (reverse)",
    "Cophenetic Weight Linf (reverse)",
    "Cophenetic Weight Hist Wasserstein",
    "Cophenetic Weight Hist L1",
    "Cophenetic Weight Hist L2",
    "Cophenetic Weight Hist Linf",
]
