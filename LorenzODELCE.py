"""
Lorenz system Lyapunov exponent approximation.
...
plt.xlabel('x(t)') # set x-axis label
plt.ylabel('y(t)') # set y-axis label
...
plt.title('4th order Runge-Kutta Method: Lorenz ODE at ' + PString + ':\n LCEs = ' + LCEString + ', ' + CString + '\n ' + FString)
plt.axis('equal')
